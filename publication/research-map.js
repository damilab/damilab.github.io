(() => {
  ...
  const publishedNodeLayout = {"paper-31":{"x":283.9,"y":205.9},"paper-9":{"x":265.8,"y":174},"paper-4":{"x":278.8,"y":121.9},"paper-29":{"x":222.1,"y":105.1},"paper-6":{"x":199,"y":260.6},"paper-2":{"x":517.6,"y":158.5},"paper-34":{"x":131.2,"y":148.8},"paper-17":{"x":208.8,"y":173.5},"paper-24":{"x":92,"y":144.5},"paper-26":{"x":95.4,"y":200.5},"paper-18":{"x":174.2,"y":151.6},"paper-21":{"x":134.6,"y":187},"paper-15":{"x":112.5,"y":235.5},"paper-25":{"x":261.1,"y":277.8},"paper-0":{"x":579.1,"y":243.6},"paper-5":{"x":529.9,"y":271},"paper-3":{"x":685,"y":165},"paper-7":{"x":545.9,"y":155.5},"paper-8":{"x":551.2,"y":229.6},"paper-11":{"x":730.1,"y":202},"paper-12":{"x":531.2,"y":139.6},"paper-13":{"x":118.2,"y":264.2},"paper-14":{"x":569.6,"y":272.1},"paper-16":{"x":515.8,"y":233.3},"paper-19":{"x":216,"y":217.3},"paper-23":{"x":643.1,"y":243.9},"paper-33":{"x":700.1,"y":224.1},"paper-35":{"x":660.9,"y":283},"paper-36":{"x":650.1,"y":216.9},"paper-37":{"x":699.2,"y":262.8},"paper-1":{"x":430.2,"y":255},"paper-28":{"x":379.5,"y":173.8},"paper-32":{"x":404.9,"y":149.8},"paper-10":{"x":394.5,"y":129.9},"paper-20":{"x":337.9,"y":181.1},"paper-30":{"x":334.9,"y":140.8},"paper-22":{"x":367.1,"y":254.2},"paper-27":{"x":366.3,"y":126.9},"what-did-you-do-behind-my-back-covert-indirect-prompt-injection-on-tool-using-llm-agents":{"x":259.1,"y":109.1}};
  const publishedLabelLayout = {"sub:trust|Security & Attacks":{"x":246.6,"y":92.3},"sub:trust|Robustness":{"x":125.9,"y":118.5},"sub:core|Fairness":{"x":348.9,"y":106.6},"area:core":{"x":397.8,"y":65.7},"sub:application|Finance & Society":{"x":535.5,"y":127.5},"area:application":{"x":605.3,"y":94.6},"area:trust":{"x":193.8,"y":64.3},"sub:core|Optimization":{"x":401,"y":234.1},"sub:application|Geospatial & Environment":{"x":540.8,"y":204.6},"sub:trust|Privacy & Safety":{"x":231.4,"y":236.5},"sub:application|Sports Analytics":{"x":700,"y":140},"sub:application|Science & Technology":{"x":676.9,"y":186.8},"sub:core|Transfer Learning":{"x":417.6,"y":123.9}};
  ...
  function mount(papers) {
    ...
    function loadLayout() { try { return { ...publishedNodeLayout, ...JSON.parse(localStorage.getItem('dami-research-map-layout-v3') || '{}') }; } catch { return { ...publishedNodeLayout }; } }
    function saveLayout() { localStorage.setItem('dami-research-map-layout-v3', JSON.stringify(layout)); }
    function loadLabelLayout() { try { return { ...publishedLabelLayout, ...JSON.parse(localStorage.getItem('dami-research-map-label-layout-v3') || '{}') }; } catch { return { ...publishedLabelLayout }; } }
    function saveLabelLayout() { localStorage.setItem('dami-research-map-label-layout-v3', JSON.stringify(labelLayout)); }
    ...
    host.querySelector('[data-reset]').onclick = () => { layout = { ...publishedNodeLayout }; labelLayout = { ...publishedLabelLayout }; localStorage.removeItem('dami-research-map-layout-v3'); localStorage.removeItem('dami-research-map-label-layout-v3'); nodes = papers.map(position); render(); };
